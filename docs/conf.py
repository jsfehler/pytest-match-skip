# -*- coding: utf-8 -*-
#
# pytest-match-skip documentation build configuration file, created by
...
project = u'pytest-match-skip'
copyright = u'2015, Joshua Fehler'
author = u'Joshua Fehler'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-match-skip Documentation',
     [author], 1)
]
